...
//     };
    ...
    var attachStudentHandler = function(e) {   
        ...
        //     $('.nav a[href="#create_account"]').tab('show');
        // });
        ...
        create_account_button.on('click', '.create_account_button', function (e) {
            ...
            // FINISH ME (Task 5): make a POST request to add the student
